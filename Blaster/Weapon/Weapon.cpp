...
UTexture2D* AWeapon::GetWeaponImageForType(EWeaponType MyWeaponType) 
{
	// Implement the logic to return the appropriate weapon image based on WeaponType
	//  can load and return the image here
	return nullptr; // Replace with actual implementation
}

UTexture2D* AWeapon::GetWeaponImage() const
{
	// Implement the logic to return the appropriate weapon image
	// This can load and return the image based on the weapon's type or other criteria
	return WeaponImage; // Replace with your actual logic or variable
}
...
void AWeapon::Dropped()
{
	...
	MulticastUpdateHUDWeaponSlot(WeaponType, SlotIndex);
...
void AWeapon::SetHUDWeaponSlot()
{
	...
	if (BlasterOwnerCharacter)
	{
		...
		if (BlasterOwnerController)
		{
			BlasterOwnerController->SetHUDWeaponOnSlot(WeaponType, SlotIndex);
		}
	}
}

void AWeapon::ClearHUDWeaponSlot()
{
	BlasterOwnerCharacter = BlasterOwnerCharacter == nullptr ? Cast<ABlasterCharacter>(GetOwner()) : BlasterOwnerCharacter;
	if (BlasterOwnerCharacter)
	{
		...
		if (BlasterOwnerController)
		{
			BlasterOwnerController->ClearHUDWeaponSlot(SlotIndex);
		}
	}
}

void AWeapon::MulticastUpdateHUDWeaponSlot_Implementation(EWeaponType _WeaponType, int32 _Slot)
{
	BlasterOwnerCharacter = BlasterOwnerCharacter == nullptr ? Cast<ABlasterCharacter>(GetOwner()) : BlasterOwnerCharacter;
	if (BlasterOwnerCharacter)
	{
		...
		if (BlasterOwnerController)
		{
			BlasterOwnerController->ClearHUDWeaponSlot(_Slot);
		}
	}
}
