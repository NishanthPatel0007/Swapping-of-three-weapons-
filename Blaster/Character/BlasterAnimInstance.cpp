...
void UBlasterAnimInstance::NativeUpdateAnimation(float DeltaTime)
{
	...
	if (bWeaponEquipped && BackpackWeapon1 && BackpackWeapon1->GetWeaponMesh() && BlasterCharacter->GetMesh())
	{
		LeftHandTransform = BackpackWeapon1->GetWeaponMesh()->GetSocketTransform(FName("LeftHandSocket"), ERelativeTransformSpace::RTS_World);
		FVector OutPosition;
